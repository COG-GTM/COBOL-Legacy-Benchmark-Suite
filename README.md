...
│
└── translations/          # Benchmark translation pairs
    └── python/           # Python translations, vectors, and equivalence tests
```
...
- **Python Translation Pairs**: Extend the [Python translations](translations/python/README.md) from the reference pair to the full suite, following the [COBOL-to-Python Migration Plan](documentation/technical/python-migration-plan.md).
