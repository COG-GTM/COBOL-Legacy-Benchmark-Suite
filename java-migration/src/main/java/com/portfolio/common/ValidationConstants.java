...
public final class ValidationConstants {
  ...
  public static final String INVALID_ID_MESSAGE = "Invalid Portfolio ID format",
      INVALID_ACCOUNT_MESSAGE = "Invalid Account Number format",
      INVALID_TYPE_MESSAGE = "Invalid Investment Type",
      INVALID_AMOUNT_MESSAGE = "Amount outside valid range";
}
