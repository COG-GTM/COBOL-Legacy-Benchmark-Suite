...
/**
 * Composite key for PoshistRecord - from POSHIST table PK.
 */
public class PoshistKey implements Serializable {
    ...
    public PoshistKey(String accountNo, String portfolioId, LocalDate transDate, LocalTime transTime) {
