      ...
      <Container size="md">
        <div className="space-y-12">
          <PageHeader
            ...
            subtitle="Modernized COBOL Legacy Benchmark Suite — view, analyze, and manage investment portfolios"
            className="mb-12"
          />
          ...
          >
            <div className="grid gap-6 md:grid-cols-3 max-w-5xl mx-auto animate-slide-up">
            ...
            <div className="mt-8 text-center animate-fade-in" style={{ animationDelay: '400ms' }}>
              <p className="text-sm text-muted-foreground">
                Navigation: Use <kbd className="px-2 py-1 bg-muted rounded text-xs font-mono shadow-sm">Arrow Keys</kbd> or
