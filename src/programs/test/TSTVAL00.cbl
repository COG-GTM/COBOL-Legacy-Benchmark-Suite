      ...
      *****************************************************************
       ...
       FILE-CONTROL.
           ...
           SELECT ACTUAL-RESULTS ASSIGN TO ACTFILE
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
       ...
       2800-WRITE-TEST-DETAIL.
           MOVE TEST-ID TO WS-TEST-ID-OUT
           MOVE TEST-TYPE TO WS-TEST-TYPE-OUT
           MOVE TEST-DESCRIPTION TO WS-TEST-DESC-OUT
           WRITE REPORT-RECORD FROM WS-TEST-DETAIL.
